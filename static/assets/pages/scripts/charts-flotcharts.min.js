        ...
        initCharts: function() {
            ...
            function t() {
                if (1 == $("#chart_1").size()) {
                    ...
                    for (var i = [], t = 0; t < 2 * Math.PI; t += .25) i.push([t, Math.cos(t)]);
                    for (var r = [], t = 0; t < 2 * Math.PI; t += .1) r.push([t, Math.tan(t)]);
                    $.plot($("#chart_1"), [{
                        label: "sin(x)",
                        data: e,
                        lines: {
            ...
            function i() {
                ...
                if (1 == $("#chart_2").size()) {
                    ...
                    $("#chart_2").bind("plothover", function(e, i, r) {
            ...
            function r() {
                function e() {
                    ...
                    if (!(e.x < t.xaxis.min || e.x > t.xaxis.max || e.y < t.yaxis.min || e.y > t.yaxis.max)) {
                        var i, r, n = plot.getData();
                        for (i = 0; i < n.length; ++i) {
                            var l = n[i];
                            for (r = 0; r < l.data.length && !(l.data[r][0] > e.x); ++r);
                            var h, d = l.data[r - 1],
                                c = l.data[r];
                            h = null == d ? c[1] : null == c ? d[1] : d[1] + (c[1] - d[1]) * (e.x - d[0]) / (c[0] - d[0]), o.eq(i).text(l.label.replace(/=.*/, "= " + h.toFixed(2)))
                        }
                    }
                }
                if (1 == $("#chart_3").size()) {
                    for (var t = [], i = [], r = 0; 14 > r; r += .1) t.push([r, Math.sin(r)]), i.push([r, Math.cos(r)]);
                    plot = $.plot($("#chart_3"), [{
                        data: t,
                        label: "sin(x) = -0.00",
                        lines: {
                    ...
                    var a = null,
                        s = null;
                    $("#chart_3").bind("plothover", function(t, i, r) {
                        s = i, a || (a = setTimeout(e, 50))
                    })
                }
            }
            ...
            function o() {
                function t() {
                    o.setData([e()]), o.draw(), setTimeout(t, r)
                }
                if (1 == $("#chart_4").size()) {
                    var i = {
                            series: {
            ...
            function a(topic) {
                ...
                if (1 == $("#chart_"+topic).size()) {
                    for (var t = [], i = 0; 10 >= i; i += 1) t.push([i, parseInt(30 * Math.random())]);
                    ...
                    $(".stackControls input").click(function(t) {
                        t.preventDefault(), a = "With stacking" == $(this).val() ? !0 : null, e()
                    }), $(".graphControls input").click(function(t) {
                        t.preventDefault(), s = -1 != $(this).val().indexOf("Bars"), n = -1 != $(this).val().indexOf("Lines"), l = -1 != $(this).val().indexOf("steps"), e()
                    }), e(topic)
                }
            }
            if (jQuery.plot) {
        ...
        initBarCharts: function() {
            function e(e) {
                var t = [],
                    ...
                    o = 200 + e;
                for (i = 1; i <= 20; i++) {
                    var a = Math.floor(Math.random() * (o - r + 1) + r);
                    t.push([i, a]), r++, o++
                }
                return t
            }
            ...
            0 !== $("#chart_1_2").size() && $.plot($("#chart_1_2"), [o], r)
        }
    }
}();
